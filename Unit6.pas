...
if e_1.Text='' then
  begin
    ShowMessage('ID TEKNISI BELUM DIISI DENGAN BENAR');
    end else
    if e_2.Text=''then
    begin
     ShowMessage('NAMA TEKNISI BELUM DIISI DENGAN BENAR');
    end else
    if e_3.Text=''then
    begin
    ...
    if e_4.Text=''then
    begin
     ShowMessage('BIAYA PERBAIKAN BELUM DIISI DENGAN BENAR');
     end else

  if Form6.zqry1.Locate('id_teknisi',e_1.Text,[]) then
  begin
   ShowMessage('DATA SUDAH ADA DALAM SISTEM');
   end else
  begin
   zqry1.SQL.Clear;
zqry1.SQL.Add('insert into tbl_teknisi values("'+e_1.Text+'","'+e_2.Text+'","'+e_3.Text+'","'+e_4.Text+'")');
 zqry1.ExecSQL ;

 zqry1.SQL.Clear;
 zqry1.SQL.Add('select * from tbl_teknisi');
 zqry1.Open;
...
zqry1.SQL.Clear;
zqry1.SQL.Add('Update tbl_teknisi set nm_teknisi="'+e_2.Text+'"telepon="'+e_3.Text+'"biaya_perbaikan="'+e_4.Text+'" where id_teknisi="'+id+'"');
zqry1. ExecSQL;
...
begin
zqry1.SQL.Clear;
zqry1.SQL.Add(' delete from tbl_teknisi where id_teknisi="'+id+'"');
zqry1. ExecSQL;
zqry1.SQL.Clear;
zqry1.SQL.Add('select * from tbl_teknisi');
zqry1.Open;
