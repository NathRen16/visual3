...
if e_1.Text='' then
  begin
    ShowMessage('ID Supplir BELUM DIISI DENGAN BENAR');
    end else
    if e_2.Text=''then
    begin
     ShowMessage('Nama Supplir BELUM DIISI DENGAN BENAR');
    end else
    if e_3.text=''then
    begin
 ...
 zqry1.SQL.Clear;
zqry1.SQL.Add('insert into tbl_supplier values("'+e_1.Text+'","'+e_2.Text+'","'+e_3.Text+'","'+e_4.Text+'")');
 zqry1.ExecSQL ;

 zqry1.SQL.Clear;
 zqry1.SQL.Add('select * from tbl_supplier');
 zqry1.Open;
...
zqry1.SQL.Clear;
zqry1.SQL.Add('Update tbl_supplier set alamat= "'+e_3.Text+'",telepon="'+e_4.Text+'" where id_supplier="'+id+'"');
zqry1. ExecSQL;
...
begin
zqry1.SQL.Clear;
zqry1.SQL.Add(' delete from tbl_supplier where id_supplier="'+id+'"');
zqry1. ExecSQL;
zqry1.SQL.Clear;
zqry1.SQL.Add('select * from tbl_supplier');
zqry1.Open;
